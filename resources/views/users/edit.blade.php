                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-3">
                                  <input type="text" class="form-control   @error('phone_two') is-invalid @enderror" id="phone_two"
                                      name="phone_two" value="{{ $user->phone_two }}" placeholder="phone two">
                                  @error('phone_two')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <div class="col-sm-3">
                                  <input type="text" class="form-control   @error('phone_land') is-invalid @enderror" id="phone_land"
                                      name="phone_land" value="{{ $user->phone_land }}" placeholder="Home Phone">
                                  @error('phone_land')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-2">
                                  <input type="date" class="form-control   @error('date_of_birth') is-invalid @enderror" id="date_of_birth"
                                      name="date_of_birth" value="{{ $user->date_of_birth }}" placeholder=" ">
                                  @error('email')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                                ...
                                <div class="col-sm-4">
                                    <select name="roles[]" id="roles" class="form-control multipel select2" multiple>
                                        ...
                                        @foreach ($roles as $item)
                                            <option value="{{ $item }}" @if(in_array($item,$user->roles->pluck('name')->toArray())) selected="selected" @endif >{{ $item }}</option>
                                        @endforeach
                                    </select>
                                    @error('roles')
                                        <span class="invalid-feedback" role="alert">
