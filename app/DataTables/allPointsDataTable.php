...
class allPointsDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\allPoint $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Point $model)
    {
        return $model->SELECT('points.*')->where('status','!=','10')->with('user')->newQuery();
    }
    /**
